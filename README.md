...
| `get_random_sample`	| get_random_sample(self, train_dataset, min_samples, min_features, max_features)<br><br>Function: returns a random sample of data, to send to decision tree. |
